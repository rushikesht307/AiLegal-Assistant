/* AI Legal Assistant - ChatGPT-style chat logic (Owner: Rushikesh Tambe)
   Connected to backend:
     ...
     POST /api/chat   -> RAG answers (document / CUAD)
...
async function newChat() {
  ...
  sideDocs.innerHTML = `<div class="side-item" style="color:var(--muted);"><span class="si">&#128196;</span><span class="st">No document uploaded</span></div>`;
  chatInner.innerHTML = "";
  location.reload();
}
...
fileInput.addEventListener("change", async (e) => {
  ...
  try {
    ...
    if (d.status === "success") {
      ...
      modePill.innerHTML = "&#128196; Document Mode";
      modePill.classList.add("doc");
      sideDocs.innerHTML = `<div class="side-item"><span class="si">&#128196;</span><span class="st">${d.file_name}</span></div>`;
      addBot(
...
function addUserFile(name, size) {
  ...
  row.innerHTML = `<div class="avatar">&#128100;</div>
    ...
    <div class="file-chip"><div class="fi">DOC</div><div><b>${name}</b><br>
